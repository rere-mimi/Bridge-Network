...
export function defaultElementSizes(input: {
  ...
  return {
    ...
    300: { length: 0.45, width: 0.55, height: 0.05 },
    301: { length: 0.45, width: 0.55, height: 0.05 },
    // Length ≈ pier-cap/3; width slightly > typical bottom flange (0.45 m)
    302: { length: 0.45, width: 0.55, height: 0.05 },
    306: { length: 0.5, width: 0.6, height: 0.08 },
    400: { length: 1.2, width: w, height: 4.5 },
    401: { length: 3.5, width: 0.4, height: 3.2 },
    402: { length: 1.4, width: w * 0.85, height: 1.0 },
